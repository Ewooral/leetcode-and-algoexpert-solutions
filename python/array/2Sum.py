    ...
    for i in range(len(array) - 1 ):
        ...
        for j in range(i+1, len(array)):
            ...
            if current + next_value == target_sum:
                print("Sum of elements: ", [current, next_value])
    return []
...
two_number_sum([1, -1, 2, 4, -2, 8, 3, -3, -8], 0)
    ...
    def two_number_sum_hash(self, array, target_sum):
        ...
        for i in range(len(array)):
            ...
            if target_sum - current in hash_table:
                print([current, target_sum - current])
            else:
...
two_sum.two_number_sum_hash([3, -9, - 2, 1, 2, 9, -1], 0)
print("........................................")
two_sum.two_number_sum_hash([1, -1, 2, 4, -2, 8, 3, -3, -8], 0)
